...
const Navbar = () => {
  ...
  return (
    <header className=" w-full z-50 bg-black text-white shadow-lg">
      <div className="container mx-auto flex items-center justify-between p-5">
        ...
        <nav className="hidden md:flex items-center text-base justify-center">
          <div className="relative">
            <button
              className="mr-5 text-1xl text-white hover:text-orange-500 hover:underline flex items-center"
          ...
          <Link to="/join-chefkart" className="mr-5 text-1xl text-white hover:underline">
            ChefKart से जुड़ें
          </Link>
          <Link to="/chef-search" className="mr-5 text-1xl text-white hover:underline">
            Cooks Near Me
          </Link>
          <Link to="/contact">
          <button className="text-white text-1xl bg-orange-500 py-2 px-6 rounded-lg hover:bg-orange-600">
            Contact Us
          </button>
          </Link>
          <Link to="/register-chef">
          <button className="text-white text-1xl  py-2 px-6 rounded-lg ">
